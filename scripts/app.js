...
/* harmony import */ var _RemovalSet__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./RemovalSet */ "./node_modules/@cycle/dom/lib/es6/RemovalSet.js");
/* harmony import */ var _PriorityQueue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./PriorityQueue */ "./node_modules/@cycle/dom/lib/es6/PriorityQueue.js");
/* harmony import */ var _fromEvent__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./fromEvent */ "./node_modules/@cycle/dom/lib/es6/fromEvent.js");
...
/***/ "./node_modules/@cycle/dom/lib/es6/RemovalSet.js":
/*!*******************************************************!*\
  !*** ./node_modules/@cycle/dom/lib/es6/RemovalSet.js ***!
  \*******************************************************/
/*! exports provided: default */
...
module.exports = h('svg', {key: 'svg-cyclejs_logo',
attrs: {"viewBox":"0 0 640 640","class":"svg-icon"}},
[h('g', {attrs: {}},
[h('linearGradient', {attrs: {"id":"SVGID_1_","gradientUnits":"userSpaceOnUse","x1":"186.7628","y1":"637.3832","x2":"553.4463","y2":"2.2687"}},
[h('stop', {attrs: {"offset":"0.4147","style":"stop-color:#51D3D9"}},
[]),
h('stop', {attrs: {"offset":"1","style":"stop-color:#C8FF8C"}},
[])]),
h('path', {attrs: {"fill":"url(#SVGID_1_)","d":"M639.9,495.8c-0.3,6.5-2.1,12.9-5.4,18.7l-60.6,105c-7.3,12.7-20.8,20.5-35.4,20.5H202.2   c-14.6,0-28.1-7.8-35.4-20.4L5.5,340.5C1.8,334.1,0,327.1,0,320c0-7.1,1.4-14.5,5.7-21.7L166.9,20.4C174.2,7.8,187.7,0,202.2,0   h336.3c14.6,0,28.1,7.8,35.4,20.4c0,0,58.3,95.5,62.5,102.3s3.5,15.4,3.5,22.4c0,6-1.7,14.2-3.3,20.7   c-1.6,6.5-50.4,204.3-50.4,204.3L479.7,143.6H261.4L159.2,320l102.2,176.4h218.2L639.9,495.8z"}},
[]),
h('linearGradient', {attrs: {"id":"SVGID_2_","gradientUnits":"userSpaceOnUse","x1":"534.3859","y1":"527.9686","x2":"631.4118","y2":"359.9149"}},
[h('stop', {attrs: {"offset":"0.4147","style":"stop-color:#51D3D9"}},
[]),
h('stop', {attrs: {"offset":"1","style":"stop-color:#5A919B"}},
[])]),
h('path', {attrs: {"fill":"url(#SVGID_2_)","d":"M562.1,319.9l74,156.9c5.7,12.1,5.1,26.2-1.6,37.8l-154.8-18.1L562.1,319.9z"}},
[])])]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _cycle_run__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @cycle/run */ "./node_modules/@cycle/run/lib/es6/index.js");
/* harmony import */ var xstream__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! xstream */ "./node_modules/xstream/index.js");
/* harmony import */ var xstream__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(xstream__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _cycle_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @cycle/http */ "./node_modules/@cycle/http/lib/es6/index.js");
/* harmony import */ var _drivers_log__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./drivers/log */ "./src/scripts/drivers/log.js");
/* harmony import */ var _dom_index__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./dom/index */ "./src/scripts/dom/index.js");
...
var queryToRequest = function queryToRequest(queryString) {
  return {
...
function main(sources) {
  var DOM = sources.DOM,
      HTTP = sources.HTTP; // we'll select submit events from the search form, pull out the query string, and
  // map it to the query object that the HTTP driver expects

  var request$ = DOM // DOM emits a stream of all our elements, we'll filter out everything but
  // the search form
  .select('#search-form') // we only care about form submit events, so let's get a stream of those
  .events('submit', {
    preventDefault: true
  }) // pull out the value of the 'q' input, resulting in a stream of query strings
  .map(function (ev) {
    return new FormData(ev.target).get('q');
  }) // we want to send an initial request for "engineering" articles, so start with that
  .startWith("engineering") // finally, map the stream of strings to a stream of request objects
  .map(queryToRequest); // the HTTP driver emits a stream of responses. We labeled our queries as
  // 'query result' in the queryToRequest function, let's pull out the corresponding
  // responses here

  var response$ = HTTP.select("query result") // HTTP.select gives us a stream of streams, let's flatten that into a single stream
  .flatten() // since we're connecting the response$ directly to the vdom$, it needs an initial
  ...
  var vdom$ = response$.map(function (res) {
    return Object(_dom_index__WEBPACK_IMPORTED_MODULE_5__["default"])(res.body);
  }); // let's log all requests and responses to console

  var log$ = xstream__WEBPACK_IMPORTED_MODULE_1___default.a.merge(request$.map(function (req) {
    return {
      type: 'query',
      content: req
    };
...
var sources = {
  ...
  DOM: Object(_cycle_dom__WEBPACK_IMPORTED_MODULE_2__["makeDOMDriver"])("body"),
  HTTP: Object(_cycle_http__WEBPACK_IMPORTED_MODULE_3__["makeHTTPDriver"])(),
  LOG: Object(_drivers_log__WEBPACK_IMPORTED_MODULE_4__["makeLogDriver"])()
};
Object(_cycle_run__WEBPACK_IMPORTED_MODULE_0__["run"])(main, sources);

/***/ }),

/***/ "./src/scripts/dom/index.js":
/*!**********************************!*\
  !*** ./src/scripts/dom/index.js ***!
  \**********************************/
/*! exports provided: default */
...
/* harmony import */ var _cycle_dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @cycle/dom */ "./node_modules/@cycle/dom/lib/es6/index.js");
/* harmony import */ var _assets_cyclejs_logo_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../assets/cyclejs_logo.svg */ "./src/assets/cyclejs_logo.svg");
/* harmony import */ var _assets_cyclejs_logo_svg__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_assets_cyclejs_logo_svg__WEBPACK_IMPORTED_MODULE_1__);



var entry = function entry(article) {
  return Object(_cycle_dom__WEBPACK_IMPORTED_MODULE_0__["a"])(".post-list-item", {
    props: {
      href: article.url,
      target: '_blank'
    }
...
var buildSearchForm = function buildSearchForm() {
  return Object(_cycle_dom__WEBPACK_IMPORTED_MODULE_0__["form"])('#search-form.search-form', {
    props: {
      action: "",
      method: "GET"
    }
  }, [Object(_cycle_dom__WEBPACK_IMPORTED_MODULE_0__["input"])(".search-input", {
    props: {
      name: "q",
      type: "text",
  ...
  }), Object(_cycle_dom__WEBPACK_IMPORTED_MODULE_0__["button"])(".search-btn", {
    props: {
      type: "submit"
    }
  }, "search")]);
...
function build(articles) {
  return Object(_cycle_dom__WEBPACK_IMPORTED_MODULE_0__["div"])("#app.layout", [Object(_cycle_dom__WEBPACK_IMPORTED_MODULE_0__["header"])(".app-header", Object(_cycle_dom__WEBPACK_IMPORTED_MODULE_0__["div"])(".layout-container", Object(_cycle_dom__WEBPACK_IMPORTED_MODULE_0__["div"])(".app-header-content", [Object(_cycle_dom__WEBPACK_IMPORTED_MODULE_0__["div"])(".header-image", _assets_cyclejs_logo_svg__WEBPACK_IMPORTED_MODULE_1___default.a), buildSearchForm()]))), Object(_cycle_dom__WEBPACK_IMPORTED_MODULE_0__["div"])(".layout-container", [Object(_cycle_dom__WEBPACK_IMPORTED_MODULE_0__["article"])(".app-main", Object(_cycle_dom__WEBPACK_IMPORTED_MODULE_0__["div"])(".post-list", articles ? articles.length ? articles.map(entry) : Object(_cycle_dom__WEBPACK_IMPORTED_MODULE_0__["span"])(".post-list-item", "No results :(") : "")), Object(_cycle_dom__WEBPACK_IMPORTED_MODULE_0__["footer"])(".app-footer", ["made with ", Object(_cycle_dom__WEBPACK_IMPORTED_MODULE_0__["a"])({
    props: {
...
/***/ "./src/scripts/drivers/log.js":
/*!************************************!*\
  !*** ./src/scripts/drivers/log.js ***!
  \************************************/
/*! exports provided: makeLogDriver */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeLogDriver", function() { return makeLogDriver; });
/**
 * A simple log driver that uncritically dumps messages to the console.
 */
function makeLogDriver() {
  return function (msg$) {
    return msg$.addListener({
